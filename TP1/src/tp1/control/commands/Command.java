...
public abstract class Command {
	 ...
	 * @throws OffWorldException 
		 */
	  public abstract ExecutionResult execute(GameModel game) throws CommandExecuteException, NotAllowedMoveException, OffWorldException;	  
	  
	  public abstract Command parse(String[] parameters) throws CommandParseException, NotAllowedMoveException;
