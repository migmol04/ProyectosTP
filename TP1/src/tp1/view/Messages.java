...
public class Messages {
	...
	public static final String COMMAND_RESET_HELP = "resets the game using the initial configuration in the file";
	...
	public static final String COMMAND_SHOOT_SHORTCUT = "i";
